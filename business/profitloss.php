...
function recurSearchLib($c, $parentID, $selector)
{
    ...
    foreach ($results as $item) {
        ...
        $total = round($total);
        echo "<tr class='accordian-body collapse' id='child$item->parentID' data-href='$item->chartofaccount_id'>
                <td colspan='3' class='hiddenRow'>
                    <div data-toggle='collapse' class='accordion-toggle d-flex flex-row p-1 pl-5' data-target='#child$item->account_catagory_id'>
                        <div>
                            $icon
                        ...
                        <tbody class="p-0">
                         ...
                         WHERE account_catagory.catagory  = ? AND chartofaccount.company_id = ?";
                            ...
                            foreach ($results as $item) {
                                ...
                                $total = round($total);
                                echo "<tr data-toggle='collapse' data-target='#child$item->account_catagory_id' data-href='$item->chartofaccount_id class='accordion-toggle p-0 Liabilitiesrow'>
                                                <td>
                                                    $icon
                                                    <span>$item->account_name</span>
                                                </td>
