                                ...
                                <div class="form-group">
                                    ...
                                    <select id="Currency" name="Currency" class="form-control">
                                        ...
                                        foreach ($currency as $cur) {
                                            $selected = $cur->mainCurrency == 1 ? "selected" : "";
                                            $mainCurrency = $cur->mainCurrency == 1 ? $cur->currency : $mainCurrency;
                                            echo "<option value='$cur->company_currency_id' $selected>$cur->currency</option>";
                                        }
                                        ?>
                                    </select>
                                </div>
                                            ...
                                            <div class="tab-content">
                                                <div role="tabpanel" class="tab-pane active" id="bankPanel" aria-labelledby="bank-tab" aria-expanded="true">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="bank" name="bankfrom" class="form-control accounts">
                                                            <option value="NA" selected>Select Bank</option>
                                                            <?php
                                                            foreach ($allBanks as $bank) {
                                                                if ($bank->currency == $mainCurrency) {
                                                                    echo "<option class='$bank->currency' value='$bank->chartofaccount_id'>$bank->account_name</option>";
                                                                } else {
                                                                    echo "<option class='d-none $bank->currency' value='$bank->chartofaccount_id'>$bank->account_name</option>";
                                                                }
                                                            }
                                                            ?>
                                                        </select>
                                                ...
                                                <div class="tab-pane" id="saifPanel" role="tabpanel" aria-labelledby="saif-tab" aria-expanded="false">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="saif" name="saiffrom" class="form-control accounts">
                                                            <option value="NA" selected>Select Saif</option>
                                                            <?php
                                                            foreach ($allSaifs as $saif) {
                                                                if ($saif->currency == $mainCurrency) {
                                                                    echo "<option class='$saif->currency' value='$saif->chartofaccount_id'>$saif->account_name</option>";
                                                                } else {
                                                                    echo "<option class='d-none $saif->currency' value='$saif->chartofaccount_id'>$saif->account_name</option>";
                                                                }
                                                            }
                                                            ?>
                                                        </select>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="tab-content">
                                                <div role="tabpanel" class="tab-pane active" id="bankPanelTo" aria-labelledby="bank-tab-to" aria-expanded="true">
                                                    <div class="form-group">
                                                        <label for="bank">Bank</label>
                                                        <select id="bank" name="bankto" class="form-control accounts">
                                                            <option value="NA" selected>Select Bank</option>
                                                            <?php
                                                            foreach ($allBanks as $bank) {
                                                                if ($bank->currency == $mainCurrency) {
                                                ...
                                                <div class="tab-pane" id="saifPanelTo" role="tabpanel" aria-labelledby="saif-tab-to" aria-expanded="false">
                                                    <div class="form-group">
                                                        <label for="saif">Saif</label>
                                                        <select id="saif" name="saifto" class="form-control accounts">
                                                            <option value="NA" selected>Select Saif</option>
                                                            <?php
                                                            foreach ($allSaifs as $saif) {
                                                                if ($saif->currency == $mainCurrency) {
...
<script>
    $(document).ready(function() {
        ...
        $("#Currency").on("change", function() {
            ...
            $(".accounts option").addClass("d-none");
