...
$all_receipt_data = $receipt->getPaymentLeadger($user_data->company_id, $financial_term);
                        ...
                        <tbody>
                            ...
                            foreach ($all_receipt as $transactions) {
                                ...
                                echo "<tr>
                                            ...
                                            <td>
                                                <a class='text-blue' href='Edite.php?edit=$transactions->leadger_id&op=payment'><span class='las la-edit la-2x hover'></span></a>
            ...
            $.post("../app/Controllers/Payments.php", {
                ...
                if (ndata.length > 0) {
                    ...
                    ndata.forEach(element => {
                        ...
                        btn = `<a class='text-blue' href='Edite.php?edit=${element.leadger_ID}&op=payment'><span class='las la-edit la-2x hover'></span></a>
