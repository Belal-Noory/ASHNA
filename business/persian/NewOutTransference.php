                            ...
                            <form class="outtransferform form">
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="currency">کمیشن</label>
                                                            ...
                                                            <div class="d-flex justify-content-between align-items-center senderAttach">
                                                                ...
                                                                <div class="form-group">
                                                                    <select type="text" id="attachTypesender" class="form-control" placeholder="Type" name="attachTypesender">
                                                                        ...
                                                                        <option value="TIN">نمیر تشخصیه</option>
                                    ...
                                    <div class="col-lg-12 mb-1 mt-0">
                                        <div class="pen-outer">
                                            <div class="pulldown">
                                                <h3 class="card-title mr-2">نوع پرداخت  </h3>
