                        ...
                        <tbody>
                            ...
                            foreach ($all_receipt as $transactions) {
                                ...
                                echo "<tr>
                                            ...
                                            <td>
                                                <a class='text-blue' href='Edite.php?edit=$transactions->leadger_id&op=revenue'><span class='las la-edit la-2x hover'></span></a>
            ...
            $.post("../app/Controllers/Revenue.php", {
                ...
                if (ndata.length > 0) {
                    ...
                    ndata.forEach(element => {
                        ...
                        btn = `<a class='text-blue' href='Edite.php?edit=${element.leadger_ID}&op=revenue'><span class='las la-edit la-2x hover'></span></a>
