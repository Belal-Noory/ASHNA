...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST["addouttransfer"])) {
        ...
        $ret = array('date' => $date, 'lid' => $leadger_id, 'tid' => $transfer_ID, 'currency' => $cdetails->currency, 'amount' => $amount, 'details' => $details, 'pby' => $loged_user->fname . ' ' . $loged_user->lname,'tcode'=>$transfercode,'address'=>$saraf_cus_id_details->office_address+","+$saraf_cus_id_details->official_phone+","+$saraf_cus_id_details->personal_phone);
