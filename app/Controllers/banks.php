...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST["addbalance"])) {
        ...
        $res = $banks->addOpeningBalanceLeadger([$account,0, $currency_data->company_currency_id, 'Opening Balance', $financial_term, time(),0, 1, $loged_user->user_id, 0, 'Opening Balance',0, $loged_user->company_id,0,0]);
