...
class Banks
{
    ...
    {
        $query = "INSERT INTO `general_leadger`(`recievable_id`, `payable_id`, `currency_id`, `remarks`, `company_financial_term_id`, `reg_date`, `currency_rate`, `approved`, `createby`, `updatedby`, `op_type`, `cleared`, `company_id`, `rcode`, `deleted`)
         VALUES ('[?]','[?]','[?]','[?]','[?]','[?]','[?]','[?]','[?]','[?]','[?]','[?]','[?]','[?]','[?]')";
        $result = $this->conn->Query($query, $params, true);
        return $result;
    }
